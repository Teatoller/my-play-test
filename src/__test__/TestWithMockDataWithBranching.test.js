...
import TestWithMockDataWithBrancing from "../components/testWithMockData/TestWithMockDataWithBranching";
...
test("List renders succesfully", () => {
  render(<TestWithMockDataWithBrancing data={mockData} displayUnorderedList={true} />);
...
test("Ordered list renders", () => {
  render(
    <TestWithMockDataWithBrancing data={mockData} displayUnorderedList={false} />
  );
